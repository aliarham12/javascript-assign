                                                          //ASSIGNMENT NO:1
alert("Assalam-o-Alaikum, my name is Ali Rashid");
...
console.log(value);
                                                            //ASSIGNMENT NO:2
var username="Ali Rashid";
alert(username);
var myName="Ali Rashid";
alert(myName);
...
alert(biodata);
alert("Pizza \n Pizz \n Piz \n Pi \n P");
var email="ali.rashid0335@gmail.com";
...
document.write(Visitorsname+" "+"ordered"+" "+Quantity+"(s)"+ " on " + producttitle+"</br></br>");
                                                          //ASSIGNMENT NO:4
//qno:1
var Name="Ali Rashid", Year="1998" , Rollno="WM2168";
